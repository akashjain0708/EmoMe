...
var createPolarChart = function(happyVal, sadVal, angerVal, neutralVal, chartID){
    var ctx = document.getElementById(chartID);
    var polarChart = new Chart(ctx,{
        ...
        data: {
            ...
            datasets: [{
                data: [happyVal, sadVal, angerVal, neutralVal],
                backgroundColor: ["#d30845", "#33701a", "#ff442b", "#0a96b2"]
            }]
        },
        options: {
            animateRotate: true,
...
createPolarChart(40,20,15,25,'polarChart');